    ...
    tabPanel("Statistical Analysis",
             div(class = "main-container",
                 ...
                 div(class = "filters-box",
                     h3(style = "margin-top: 0; color: #2d5016;", "Data Filters"),
                     fluidRow(
                       column(4,
                              sliderInput("life_exp_filter", "Life Expectancy Range (years):",
                       ...
                       column(4,
                              selectInput("region_filter", "Region:",
                                          choices = c("All", "North Central", "Northeast", "South", "West"),
                                          selected = "All")
                       )
                     )
                 ),
                 ...
                 div(class = "content-box",
                     h2("Regression Diagnostics"),
                     plotOutput("regression_plot", height = 500)
                 ),
                 
                 div(class = "content-box",
                     h2("ANOVA Analysis by Region"),
                     p("Analysis of variance examining differences in life expectancy across U.S. regions."),
                     verbatimTextOutput("anova_results")
                 ),
                 
                 div(class = "content-box",
                     h2("Data Table"),
                     p("Filtered state-level data based on your selections above."),
                     DTOutput("data_table"),
                     br(),
